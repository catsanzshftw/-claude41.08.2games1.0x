...
# --- SM64DS-Inspired Physics (PATCHED) ---
GRAVITY = 0.6
PLAYER_WALK_ACC = 0.5
PLAYER_RUN_ACC = 0.9
...
PLAYER_JUMP_BOOST = -1.2  # Reduced from -2.5 for more controlled jumps
MAX_WALK_SPEED = 4
MAX_RUN_SPEED = 7
ENEMY_SPEED = 1
...
class Player(pygame.sprite.Sprite):
    ...
    def draw_player(self):
        ...
        # Eyes (animated)
        current_blink = self.animation_timer % 120 < 110
        if current_blink:
    ...
    def update_jump(self):
        ...
        if self.jump_held and self.jump_timer < 6 and self.vel.y < 0:  # Reduced from 10 frames
        ...
        while not level_complete:
            ...
            if enemy_hit and enemy_hit.alive:
                ...
                if (player.vel.y > 1 and 
                    ...
                    player.vel.y = -8  # Fixed bounce height, not a rocket jump!
                    # Stomp particles
                    for i in range(6):
                        add_particle(
